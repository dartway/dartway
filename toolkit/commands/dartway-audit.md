...
- **1.2 Длинные файлы (мягкий сигнал)** — посчитай длину всех `.dart` в области; >200 строк — ворнинг (вероятная «свалка ответственностей», выпиши по убыванию), 120–200 — просто отметь. Смотри на ответственности, а не на счётчик: осмысленный файл на 220 строк лучше бессмысленного попила.
