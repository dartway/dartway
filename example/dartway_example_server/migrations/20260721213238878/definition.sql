...
--
-- Class AppSetting as table app_setting
--
...
--
-- Class ChatChannel as table chat_channel
--
...
--
-- Class ClubService as table club_service
--
...
--
-- Class ClubSession as table club_session
--
...
--
-- Class NewsPost as table news_post
--
...
--
-- Class SessionBooking as table session_booking
--
...
--
-- Class SessionReview as table session_review
--
...
-- Serverpod uses definition.sql for clean database bootstrap. Keep
-- vacuum/analyze responsive on this intentionally high-churn queue here too.
...
--
-- Foreign relations for "club_session" table
--
...
--
-- Foreign relations for "news_post" table
--
...
--
-- Foreign relations for "session_booking" table
--
...
--
-- Foreign relations for "session_review" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('dartway_example', '20260721213238878', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260721213238878', "timestamp" = now();
