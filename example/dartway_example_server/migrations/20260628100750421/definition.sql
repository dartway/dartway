...
--
-- Class FeedPost as table feed_post
--
...
--
-- Class WaterIntake as table water_intake
--
CREATE TABLE "water_intake" (
    "id" bigserial PRIMARY KEY,
    "userProfileId" bigint NOT NULL,
    "intakeAmount" bigint NOT NULL,
    "intakeTime" timestamp without time zone NOT NULL
);
...
--
-- Foreign relations for "feed_post" table
--
ALTER TABLE ONLY "feed_post"
    ADD CONSTRAINT "feed_post_fk_0"
...
--
-- Foreign relations for "water_intake" table
--
ALTER TABLE ONLY "water_intake"
    ADD CONSTRAINT "water_intake_fk_0"
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('dartway_example', '20260628100750421', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260628100750421', "timestamp" = now();
