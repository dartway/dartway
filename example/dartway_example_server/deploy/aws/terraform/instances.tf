...
resource "aws_launch_configuration" "serverpod" {
  name_prefix = "${var.dartway_example}-"
...
resource "aws_autoscaling_group" "serverpod" {
  ...
  tag {
    key                 = "Name"
    value               = "${var.dartway_example}-serverpod"
    propagate_at_launch = true
  }

  tag {
    key                 = "CodeDeploy"
    value               = var.dartway_example
    propagate_at_launch = true
  }
}

resource "aws_security_group" "serverpod" {
  name = "${var.dartway_example}-serverpod"
