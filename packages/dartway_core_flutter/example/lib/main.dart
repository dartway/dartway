// A runnable tour of dartway_core_flutter. Copy the folder, `flutter run`, and read
...
class _ExampleApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'dartway_core_flutter tour',
...
class _TourScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Scaffold(
      appBar: AppBar(title: const Text('dartway_core_flutter')),
      body: ListView(
