...
import '../repository/domain/dw_infinite_list_view_config.dart';
import '../repository/domain/dw_infinite_list_view_grouped_item.dart';
          ...
          if (item is DwInfiniteListViewGroupHeader) {
            ...
            if (isFirstHeader || widget.groupDivider == null) {
              ...
              return Column(
                ...
                children: [
                  widget.groupDivider!, // before the header
                  item.widget,
                ],
              );
            }
