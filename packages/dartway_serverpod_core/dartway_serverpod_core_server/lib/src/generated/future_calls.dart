...
import '../business/auth/dw_orphaned_auth_key_cleanup.dart' as _i3;
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'DwOrphanedAuthKeyCleanupRunFutureCall':
          DwOrphanedAuthKeyCleanupRunFutureCall(),
      'DwOrphanedAuthKeyCleanupInvokeFutureCall':
          DwOrphanedAuthKeyCleanupInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final dwOrphanedAuthKeyCleanup =
      _DwOrphanedAuthKeyCleanupFutureCallDispatcher(_invokeFutureCall);
}

class _DwOrphanedAuthKeyCleanupFutureCallDispatcher {
  _DwOrphanedAuthKeyCleanupFutureCallDispatcher(this._invokeFutureCall);
...
class DwOrphanedAuthKeyCleanupRunFutureCall extends _i1.FutureCall {
  @override
  _i2.Future<void> invoke(
    _i1.Session session,
    _i1.SerializableModel? object,
  ) async {
    await _i3.DwOrphanedAuthKeyCleanup().run(session);
  }
}

class DwOrphanedAuthKeyCleanupInvokeFutureCall
