...
import 'cloud_files/dw_upload_ticket.dart' as _i13;
import 'dw_app_notification.dart' as _i14;
import 'dw_backend_filter_type.dart' as _i15;
import 'dw_channel_closed.dart' as _i16;
import 'dw_channel_closed_reason.dart' as _i17;
import 'dw_updates_transport.dart' as _i18;
import 'dw_webhook_log.dart' as _i19;
import '/src/domain/api/dw_model_wrapper.dart' as _i20;
...
import 'package:dartway_serverpod_core_server/src/domain/api/dw_order_by.dart'
    as _i22;
import '/src/domain/api/dw_api_response.dart' as _i23;
import '/src/domain/api/dw_auth_data.dart' as _i24;
import '/src/domain/api/dw_backend_filter.dart' as _i25;
import '/src/domain/api/dw_order_by.dart' as _i26;
...
export 'cloud_files/dw_upload_ticket.dart';
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  static final List<_i2.TableDefinition> targetTableDefinitions = [
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'dw_auth_request_identifier_created_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
    ...
    _i2.TableDefinition(
      ...
      indexes: [
        ...
        _i2.IndexDefinition(
          indexName: 'dw_cloud_file_bucket_path_idx',
          tableSpace: null,
          elements: [
            _i2.IndexElementDefinition(
              type: _i2.IndexElementDefinitionType.column,
  ...
  T deserialize<T>(
    ...
    if (t == _i13.DwUploadTicket) {
      return _i13.DwUploadTicket.fromJson(data) as T;
    }
    if (t == _i14.DwAppNotification) {
      return _i14.DwAppNotification.fromJson(data) as T;
    }
    if (t == _i15.DwBackendFilterType) {
      return _i15.DwBackendFilterType.fromJson(data) as T;
    }
    if (t == _i16.DwChannelClosed) {
      return _i16.DwChannelClosed.fromJson(data) as T;
    }
    if (t == _i17.DwChannelClosedReason) {
      return _i17.DwChannelClosedReason.fromJson(data) as T;
    }
    if (t == _i18.DwUpdatesTransport) {
      return _i18.DwUpdatesTransport.fromJson(data) as T;
    }
    if (t == _i19.DwWebServerLog) {
      return _i19.DwWebServerLog.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i13.DwUploadTicket?>()) {
      return (data != null ? _i13.DwUploadTicket.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i14.DwAppNotification?>()) {
      return (data != null ? _i14.DwAppNotification.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i15.DwBackendFilterType?>()) {
      return (data != null ? _i15.DwBackendFilterType.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i16.DwChannelClosed?>()) {
      return (data != null ? _i16.DwChannelClosed.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i17.DwChannelClosedReason?>()) {
      return (data != null ? _i17.DwChannelClosedReason.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i18.DwUpdatesTransport?>()) {
      return (data != null ? _i18.DwUpdatesTransport.fromJson(data) : null)
          as T;
    }
    if (t == _i1.getType<_i19.DwWebServerLog?>()) {
      return (data != null ? _i19.DwWebServerLog.fromJson(data) : null) as T;
    }
    ...
    if (t == List<_i20.DwModelWrapper>) {
      return (data as List)
              .map((e) => deserialize<_i20.DwModelWrapper>(e))
              .toList()
          as T;
    }
    if (t == _i20.DwModelWrapper) {
      return _i20.DwModelWrapper.fromJson(data) as T;
    }
    if (t == List<_i21.DwModelWrapper>) {
      return (data as List)
              .map((e) => deserialize<_i21.DwModelWrapper>(e))
              .toList()
          as T;
    }
    if (t == List<_i22.DwOrderBy>) {
      return (data as List).map((e) => deserialize<_i22.DwOrderBy>(e)).toList()
          as T;
    }
    if (t == _i1.getType<List<_i22.DwOrderBy>?>()) {
      return (data != null
              ? (data as List)
                    .map((e) => deserialize<_i22.DwOrderBy>(e))
                    .toList()
              : null)
          as T;
    }
    if (t == _i23.DwApiResponse) {
      return _i23.DwApiResponse.fromJson(data) as T;
    }
    if (t == _i24.DwAuthData) {
      return _i24.DwAuthData.fromJson(data) as T;
    }
    if (t == _i25.DwBackendFilter) {
      return _i25.DwBackendFilter.fromJson(data) as T;
    }
    if (t == _i26.DwOrderBy) {
      return _i26.DwOrderBy.fromJson(data) as T;
    }
    if (t == _i1.getType<_i20.DwModelWrapper?>()) {
      return (data != null ? _i20.DwModelWrapper.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i23.DwApiResponse?>()) {
      return (data != null ? _i23.DwApiResponse.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i24.DwAuthData?>()) {
      return (data != null ? _i24.DwAuthData.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i25.DwBackendFilter?>()) {
      return (data != null ? _i25.DwBackendFilter.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i26.DwOrderBy?>()) {
      return (data != null ? _i26.DwOrderBy.fromJson(data) : null) as T;
    }
    try {
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      _i20.DwModelWrapper => 'DwModelWrapper',
      _i23.DwApiResponse => 'DwApiResponse',
      _i24.DwAuthData => 'DwAuthData',
      _i25.DwBackendFilter => 'DwBackendFilter',
      _i26.DwOrderBy => 'DwOrderBy',
      ...
      _i13.DwUploadTicket => 'DwUploadTicket',
      _i14.DwAppNotification => 'DwAppNotification',
      _i15.DwBackendFilterType => 'DwBackendFilterType',
      _i16.DwChannelClosed => 'DwChannelClosed',
      _i17.DwChannelClosedReason => 'DwChannelClosedReason',
      _i18.DwUpdatesTransport => 'DwUpdatesTransport',
      _i19.DwWebServerLog => 'DwWebServerLog',
      _ => null,
    };
  }
  ...
  String? getClassNameForObject(Object? data) {
    ...
    switch (data) {
      case _i20.DwModelWrapper():
        return 'DwModelWrapper';
      case _i23.DwApiResponse():
        return 'DwApiResponse';
      case _i24.DwAuthData():
        return 'DwAuthData';
      case _i25.DwBackendFilter():
      ...
      case _i12.DwCloudFile():
        return 'DwCloudFile';
      case _i13.DwUploadTicket():
        return 'DwUploadTicket';
      case _i14.DwAppNotification():
        return 'DwAppNotification';
      case _i15.DwBackendFilterType():
        return 'DwBackendFilterType';
      case _i16.DwChannelClosed():
        return 'DwChannelClosed';
      case _i17.DwChannelClosedReason():
        return 'DwChannelClosedReason';
      case _i18.DwUpdatesTransport():
        return 'DwUpdatesTransport';
      case _i19.DwWebServerLog():
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'DwModelWrapper') {
      return deserialize<_i20.DwModelWrapper>(data['data']);
    }
    if (dataClassName == 'DwApiResponse') {
      return deserialize<_i23.DwApiResponse>(data['data']);
    }
    if (dataClassName == 'DwAuthData') {
      return deserialize<_i24.DwAuthData>(data['data']);
    }
    if (dataClassName == 'DwBackendFilter') {
      return deserialize<_i25.DwBackendFilter>(data['data']);
    }
    if (dataClassName == 'DwOrderBy') {
      return deserialize<_i26.DwOrderBy>(data['data']);
    }
    ...
    if (dataClassName == 'DwUploadTicket') {
      return deserialize<_i13.DwUploadTicket>(data['data']);
    }
    if (dataClassName == 'DwAppNotification') {
      return deserialize<_i14.DwAppNotification>(data['data']);
    }
    if (dataClassName == 'DwBackendFilterType') {
      return deserialize<_i15.DwBackendFilterType>(data['data']);
    }
    if (dataClassName == 'DwChannelClosed') {
      return deserialize<_i16.DwChannelClosed>(data['data']);
    }
    if (dataClassName == 'DwChannelClosedReason') {
      return deserialize<_i17.DwChannelClosedReason>(data['data']);
    }
    if (dataClassName == 'DwUpdatesTransport') {
      return deserialize<_i18.DwUpdatesTransport>(data['data']);
    }
    if (dataClassName == 'DwWebServerLog') {
      return deserialize<_i19.DwWebServerLog>(data['data']);
    }
  ...
  _i1.Table? getTableForType(Type t) {
    ...
    switch (t) {
      ...
      case _i14.DwAppNotification:
        return _i14.DwAppNotification.t;
      case _i19.DwWebServerLog:
        return _i19.DwWebServerLog.t;
    }
    return null;
  }
