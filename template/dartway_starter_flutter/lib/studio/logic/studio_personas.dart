...
/// Fixed dev OTP accepted by the server in development run mode.
/// Keep in sync with _devVerificationCode in
/// dartway_starter_server/lib/src/dartway/dartway_core.dart.
const studioDevOtpCode = '000000';

/// Seeded demo personas declared for Studio's persona switcher
/// (see dartway_starter_server/bin/seed_dev.dart).
abstract final class StudioPersonas {
  ...
  static const staffMaria = StudioPersonaSpec(
    id: 'staff-maria',
    label: 'Staff · Maria',
  ...
  static const all = [clientIvan, staffMaria, adminAlex];
