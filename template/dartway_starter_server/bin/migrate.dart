...
/// against the database in `DW_DATABASE_*`, read only by the commands that
/// use it — `rehash` needs none. `create` and `check` work on throwaway
/// databases of their own next to it.
