...
import 'package:dartway_serverpod_core_server/dartway_serverpod_core_server.dart'
    as _i3;
import 'settings/app_setting.dart' as _i4;
import 'user_profile/enums/user_role.dart' as _i5;
...
class Protocol extends _i1.SerializationManagerServer {
  ...
  T deserialize<T>(
    ...
    if (t == _i4.AppSetting) {
      return _i4.AppSetting.fromJson(data) as T;
    }
    if (t == _i5.UserRole) {
      return _i5.UserRole.fromJson(data) as T;
    }
    if (t == _i6.UserGender) {
    ...
    if (t == _i1.getType<_i4.AppSetting?>()) {
      return (data != null ? _i4.AppSetting.fromJson(data) : null) as T;
    }
    if (t == _i1.getType<_i5.UserRole?>()) {
      return (data != null ? _i5.UserRole.fromJson(data) : null) as T;
    }
  ...
  static String? getClassNameForType(Type type) {
    return switch (type) {
      _i4.AppSetting => 'AppSetting',
      _i5.UserRole => 'UserRole',
      _i6.UserGender => 'UserGender',
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (dataClassName == 'AppSetting') {
      return deserialize<_i4.AppSetting>(data['data']);
    }
    if (dataClassName == 'UserRole') {
      return deserialize<_i5.UserRole>(data['data']);
    }
  ...
  @override
  String getModuleName() => 'dartway_starter';
