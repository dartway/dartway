...
resource "aws_launch_configuration" "serverpod" {
  name_prefix = "${var.dartway_starter}-"
...
resource "aws_autoscaling_group" "serverpod" {
  ...
  tag {
    key                 = "Name"
    value               = "${var.dartway_starter}-serverpod"
    propagate_at_launch = true
  }

  tag {
    key                 = "CodeDeploy"
    value               = var.dartway_starter
    propagate_at_launch = true
  }
}

resource "aws_security_group" "serverpod" {
  name = "${var.dartway_starter}-serverpod"
